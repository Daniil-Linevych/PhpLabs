                ...
                <div class="row g-3">
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <input type="date" name="start_date" id="start_date" class="form-control @error('start_date') is-invalid @enderror" 
                                value="{{ old('start_date', $exhibition->start_date->format('Y-m-d') ?? '') }}"></input>
                        @error('start_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <input type="date" name="end_date" id="end_date" class="form-control @error('start_date') is-invalid @enderror" 
                            value="{{ old('end_date', $exhibition->end_date->format('Y-m-d')) }}"></input>
                        @error('end_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
